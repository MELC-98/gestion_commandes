...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($erreurs)) {
        try {
            ...
            $stmt->execute([$nom, $description ?: null, $prix, $stock, $id]);
            $succes = true;
...
<head>
    ...
    <title>Modifier un Produit - Gestion des Commandes</title>
            ...
            <div class="form-container">
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="stock" name="stock" min="0" value="<?php echo htmlspecialchars($produit['stock']); ?>" required>
                    </div>
